...
class VoronoiIPv : public Colvar {
  bool pbc;
  bool serial;
...
public:
  explicit VoronoiIPv(const ActionOptions&);
  ~VoronoiIPv();
// active methods:
...
PLUMED_REGISTER_ACTION(VoronoiIPv,"VORONOIIPV")

void VoronoiIPv::registerKeywords( Keywords& keys ) {
...
VoronoiIPv::VoronoiIPv(const ActionOptions&ao):
...
void VoronoiIPv::calculate()
{
  ...
  #pragma omp parallel num_threads(nt)
  {
    ...
    ofstream outFile("INDEXs-PLUS.txt", ios::app);
    int inds[num_atomsa];
