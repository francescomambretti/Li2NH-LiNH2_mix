...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
#include "/home/fmambretti@iit.local/installed/plumed-2.8.1/src/tools/NeighborList.h"
#include "/home/fmambretti@iit.local/installed/plumed-2.8.1/src/tools/Communicator.h"
#include "/home/fmambretti@iit.local/installed/plumed-2.8.1/src/tools/OpenMP.h"
#include "/home/fmambretti@iit.local/installed/plumed-2.8.1/src/colvar/Colvar.h"

#include "/home/fmambretti@iit.local/installed/plumed-2.8.1/src/colvar/tools/Matrix.h"
#include "/home/fmambretti@iit.local/installed/plumed-2.8.1/src/colvar/ActionRegister.h"
#include <string>
#include <cmath>
#include <iostream>
#include <fstream>
...
class VoronoiICellB : public Colvar {
  bool pbc;
  bool serial;
...
public:
  explicit VoronoiICellB(const ActionOptions&);
  ~VoronoiICellB();
// active methods:
...
PLUMED_REGISTER_ACTION(VoronoiICellB,"VORONOIICELLB")

void VoronoiICellB::registerKeywords( Keywords& keys ) {
  ...
  keys.add("compulsory","CUT","0.0","The cutoff for indexes");
}

VoronoiICellB::VoronoiICellB(const ActionOptions&ao):
...
VoronoiICellB::~VoronoiICellB() {
// destructor required to delete forward declared class
}

void VoronoiICellB::prepare() {
  if(nl->getStride()>0) {
...
void VoronoiICellB::calculate()
{
  ...
  #pragma omp parallel num_threads(nt)
  {
    ...
    ofstream outFile("INDEX-CELL-BGROUP.txt", ios::app);	
    #pragma omp for
