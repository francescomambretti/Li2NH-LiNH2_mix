...
class VoronoiIPvLi : public Colvar {
  bool pbc;
  bool serial;
...
public:
  explicit VoronoiIPvLi(const ActionOptions&);
  ~VoronoiIPvLi();
// active methods:
...
PLUMED_REGISTER_ACTION(VoronoiIPvLi,"VORONOIIPVLI")

void VoronoiIPvLi::registerKeywords( Keywords& keys ) {
...
VoronoiIPvLi::VoronoiIPvLi(const ActionOptions&ao):
...
void VoronoiIPvLi::calculate()
{
  ...
  #pragma omp parallel num_threads(nt)
  {
    ...
    ofstream outFile("NUM_Li.txt", ios::app);
    int inds[num_atomsa];
