...
class VoronoiIMv : public Colvar {
  bool pbc;
  bool serial;
...
public:
  explicit VoronoiIMv(const ActionOptions&);
  ~VoronoiIMv();
// active methods:
...
PLUMED_REGISTER_ACTION(VoronoiIMv,"VORONOIIMV")

void VoronoiIMv::registerKeywords( Keywords& keys ) {
...
VoronoiIMv::VoronoiIMv(const ActionOptions&ao):
...
void VoronoiIMv::calculate()
{
  ...
  #pragma omp parallel num_threads(nt)
  {
    ...
    ofstream outFile("INDEXs-MINUS.txt", ios::app);
    int inds[num_atomsa];
