...
Before running the following, pw.x needs to be executed (usually, through the 'loop_singlepoint.sh' and 'sbatch_scf.sh' scripts contained in the 'QE_run' folder.
