...
# based on sel_conf_devi.py
# select configurations based upon the value of max_devi_f  --> to be used as test set
...
fractions=[0.05,0.1,0,0] #take this fraction of configurations from each subgroup -> can be changed
